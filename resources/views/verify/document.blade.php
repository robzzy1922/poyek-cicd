...
<head>
    ...
    <title>Verifikasi Dokumen Signix</title>
...
<body>
    <div class="min-h-screen py-16 bg-gray-50">
        <div class="container px-4 mx-auto">
            <div class="max-w-4xl mx-auto overflow-hidden bg-white border border-gray-200 shadow-xl rounded-2xl">
                ...
                <div class="p-8">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600">
                            ...
                            {{
                            \Carbon\Carbon::parse($dokumen->tanggal_verifikasi)->setTimezone('Asia/Jakarta')->format('d
                            M Y H:i:s') }}
                            @else
                            -
                            @endif
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center">
                                ...
                                <div class="flex items-center w-2/3 space-x-2">
                                    <code
                                        class="flex-1 px-4 py-2 font-mono text-sm tracking-wider border border-gray-200 rounded-lg bg-gray-50">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="w-2/3 px-4 py-2 font-medium text-gray-900">{{ $dokumen->nomor_surat
                                    }}</span>
                            </div>

                            <div class="flex items-center">
                                <span class="w-1/3 text-gray-600">Tanggal Pengajuan:</span>
                                <span class="w-2/3 px-4 py-2 font-medium text-gray-900">{{ $dokumen->tanggal_pengajuan
                                    }}</span>
                            </div>

                            <div class="flex items-center">
                                <span class="w-1/3 text-gray-600">Perihal:</span>
                                <span class="w-2/3 px-4 py-2 font-medium text-gray-900">{{ $dokumen->perihal }}</span>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="w-2/3 px-4 py-2">
                                    <span
                                        class="inline-flex px-4 py-1.5 text-sm font-medium text-green-700 bg-green-100 rounded-full">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="w-2/3 px-4 py-2 font-medium text-gray-900">
                                    @if ($dokumen->dosen)
                    ...
                    <div class="mt-10 text-center">
                        <a href="{{ route('view.document', ['id' => $dokumen->id]) }}"
                            class="inline-flex items-center px-8 py-3 text-base font-medium text-white transition duration-150 ease-in-out bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 hover:shadow-lg"
                            target="_blank">
